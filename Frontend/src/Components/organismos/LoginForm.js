...
export default function Page() {
  return (
    ...
    >
      ...
      >
        <Typography variant="h4" style={{ marginBottom: '20px', color:'white'}}>SING IN</Typography>
        <TextInput label={'Email'} margin="none" width={'400px'} background={'#fff'} />
        <TextInput label={'Password'} margin="normal" width={'400px'} background={'#fff'}/>
